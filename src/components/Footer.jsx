    ...
    return (
        ...
        >
            ...
            <div className="relative z-20 max-w-7xl mx-auto flex flex-col items-center">
                ...
                {/* Title */}
                <h3 className="text-liquid-gold font-serif text-2xl tracking-[0.2em] mb-12 opacity-80">
                    CONNECT WITH ORYN
                </h3>

                {/* Social Links Grid */}
                <motion.div
                    className="grid grid-cols-2 lg:grid-cols-5 gap-6 mb-20 w-full"
                ...
                >
                    {socialLinks.map(({ href, label, Icon, highlight }, index) => (
                        <motion.a
                            ...
                            className={`
                                ...
                                flex flex-col items-center justify-center gap-4 py-8 px-6 rounded-2xl
                                backdrop-blur-xl border transition-all duration-500
                                ${highlight
                                    ? 'bg-[#D4AF37]/10 border-[#D4AF37]/50 shadow-[0_0_30px_rgba(212,175,55,0.2)]'
                                    : 'bg-white/5 border-white/10 hover:border-[#D4AF37]/50 hover:bg-[#D4AF37]/5'}
                            `}
                            whileHover={{
                                scale: 1.05,
                                y: -5,
                        ...
                        >
                            {/* Inner Glow Shader Effect */}
                            <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

                            {/* Icon */}
                            <div className={`
                                p-4 rounded-full transition-all duration-500
                                ${highlight ? 'bg-[#D4AF37] text-black' : 'bg-white/10 text-white group-hover:bg-[#D4AF37] group-hover:text-black'}
                            `}>
                                <Icon />
                            </div>
                            ...
                            <span className={`
                                ...
                                ${highlight ? 'text-[#D4AF37]' : 'text-neutral-400 group-hover:text-[#D4AF37]'}
                            `}>
                                {label}
                            </span>
                        </motion.a>
                    ...
                    <motion.div
                        className="
                            relative group overflow-hidden
                            flex flex-col items-center justify-center gap-3 py-8 px-6 rounded-2xl
                            bg-white/5 border border-white/10 backdrop-blur-xl
                            hover:border-[#D4AF37] hover:bg-black/50 hover:shadow-[0_0_40px_rgba(212,175,55,0.3)]
                            transition-all duration-500 cursor-copy
                        "
                        whileHover={{ scale: 1.05, y: -5 }}
                        onClick={() => navigator.clipboard.writeText('oryn.tw@gmail.com')}
                    >
                        <div className="p-3 rounded-full bg-white/10 text-white group-hover:bg-[#D4AF37] group-hover:text-black transition-all">
                            <EmailIcon />
                        </div>
                        <span className="text-sm font-bold text-neutral-400 group-hover:text-[#D4AF37] tracking-widest">EMAIL</span>
                        <span className="text-xs text-[#D4AF37]/60 font-mono group-hover:text-[#D4AF37]">oryn.tw@gmail.com</span>
                    </motion.div>
                </motion.div>
                ...
                <div className="flex flex-col items-center gap-4 opacity-50">
                    ...
                    <p className="text-center text-[#D4AF37] text-xs font-serif tracking-[0.3em]">
                        © 2026 ORYN. 照亮未來。
                    </p>
                </div>
            </div>
